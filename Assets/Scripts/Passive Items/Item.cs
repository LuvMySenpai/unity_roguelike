...
/// <summary>
/// Base class for both Passive and the Weapon classes
/// </summary>
...
public abstract class Item : MonoBehaviour
{
    ...
    public virtual void Initialise(ItemData data)
    {
        ...
        // Store the evolution data as system have to track whether
        // all the catalysts are in the inventory so weapon can evolve.
        evolutionData = data.evolutionData;

        // Have to find a better way to reference the player inventory
